...
namespace DAL
{
    ...
    public partial class MySqlUserPrize
    {
        ...
        private readonly DAL.MySqlPrize dalPZ = new DAL.MySqlPrize();
        ...
        ///// 增加一条兑换信息
        ///// </summary>
        public bool Add(Model.UserPrize model,out string msg)
        {
            ...
            //查询兑换该奖品需要多少积分
            Model.Prize prize = dalPZ.GetModel(model.PrizeID);
            ...
            List<Model.Integral> igList = DataTableToListForInt(ds.Tables[0]);
        ...
        /// 得到一条数据
        /// </summary>
        public Model.UserPrize GetModel(long AutoID)
        {
            ...
            Model.UserPrize model = new Model.UserPrize();
        ...
        /// 取消一次兑换
        /// </summary>
        public bool Delete(Model.UserPrize model, out string msg)
        {
        ...
        /// </summary>
        public List<Model.Integral> DataTableToListForInt(DataTable dt)
        {
     ...
     /// <returns></returns>
        public bool PrizeTaken(Model.UserPrize model,out string msg)
        { 
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.UserPrize DataRowToModel(DataRow row)
        {
            Model.UserPrize model = new Model.UserPrize();
            if (row != null)
            {
