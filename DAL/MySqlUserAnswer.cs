...
namespace DAL
{
    ...
    public partial class MySqlUserAnswer
    {
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.UserAnswer GetModel(long QuestionID, long UserID)
        {
            ...
            Model.UserAnswer model = new Model.UserAnswer();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.UserAnswer DataRowToModel(DataRow row)
        {
            Model.UserAnswer model = new Model.UserAnswer();
