...
{
    /// <summary>
    /// 数据访问类:MySqlMessageToObject
    /// </summary>
    public partial class MySqlMessageToObject
    {
        public MySqlMessageToObject()
        { }
        #region  BasicMethod
        ...
        public bool Exists(long AutoID)
        {
            ...
            strSql.Append("select count(1) from MessageToObject");
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(Model.MessageToObject model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Model.MessageToObject model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public bool Delete(long AutoID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from MessageToObject ");
            strSql.Append(" where AutoID=@AutoID ");
            MySqlParameter[] parameters = {
					new MySqlParameter("@AutoID", MySqlDbType.Int64)			};
            parameters[0].Value = AutoID; 
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select AutoID,MsgID,ObjType,ObjValue ");
            strSql.Append(" FROM MessageToObject ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int key, string value, int Top, int filedOrder, bool desc)
        {
            ...
            switch (key)
            {
                case 0: strWhere = "AutoID = @AutoID";
                    ...
                    break;
                case 1: strWhere = "MsgID = @MsgID";
                    parameter = new MySqlParameter("@MsgID", MySqlDbType.Int64);
                    parameter.Value = value;
                    break;
                case 2: strWhere = "ObjType = @ObjType";
                    parameter = new MySqlParameter("@ObjType", MySqlDbType.VarChar, 50);
                    parameter.Value = value;
                    break;
                case 3: strWhere = "ObjValue = @ObjValue";
                    parameter = new MySqlParameter("@ObjValue", MySqlDbType.VarChar, 50);
                    parameter.Value = value;
                    break;
                default: break;
            }
            ...
            switch (filedOrder)
            {
                ...
                case 1: strOrder = "MsgID"; break;
                case 2: strOrder = "ObjType"; break;
                case 3: strOrder = "ObjValue"; break;
                default: break;
            }
            if (strOrder.Trim() != "")
            {
        ...
        public DataSet GetListByPage(int key, string value, int filedOrder, bool desc, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from MessageToObject T ");
