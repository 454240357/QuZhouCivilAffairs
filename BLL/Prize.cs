...
namespace BLL
{
    ...
    {
        private readonly DAL.MySqlPrize dal = new DAL.MySqlPrize();
        public Prize()
        { }
        #region  BasicMethod
        /// <summary>
        ...
        /// 增加奖品
        /// </summary>
        public long Add(Model.Prize model)
        {
        ...
        /// 更新奖品
        /// </summary>
        public bool Update(Model.Prize model)
        {
        ...
        /// <param name="desc">选用倒序</param>
        /// <returns>奖品集合</returns>
        public List<Model.Prize> GetModelList(int key, string value, int Top, int filedOrder, bool desc)
        {
        ...
        /// 将DateTable转成实体类集合
        /// </summary>
        public List<Model.Prize> DataTableToList(DataTable dt)
        {
            List<Model.Prize> modelList = new List<Model.Prize>();
        ...
        /// </summary>
        /// <returns>奖品集合</returns>
        public List<Model.Prize> GetAllModelList()
        {
