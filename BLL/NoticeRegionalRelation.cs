...
namespace BLL
{
    ...
    {
        private readonly DAL.MySqlNoticeRegionalRelation dal = new DAL.MySqlNoticeRegionalRelation();
        ...
        /// 得到公告区域关联实体，从缓存中
		/// </summary>
		public Model.NoticeRegionalRelation GetModelByCache(long AutoID)
		{
			...
			return (Model.NoticeRegionalRelation)objModel;
		}
        ...
        /// <param name="desc">选用倒序</param>
        /// <returns>公告区域关联集合</returns>
        public List<Model.NoticeRegionalRelation> GetModelList(int key, string value, int Top, int filedOrder, bool desc)
        {
        ...
        /// 将DateTable转成实体类集合
        /// </summary>
        public List<Model.NoticeRegionalRelation> DataTableToList(DataTable dt)
        {
            List<Model.NoticeRegionalRelation> modelList = new List<Model.NoticeRegionalRelation>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Model.NoticeRegionalRelation model;
