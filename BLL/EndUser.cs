...
namespace BLL
{
    ...
    {
        private readonly DAL.MySqlEndUser dal = new DAL.MySqlEndUser();
        public EndUser()
        { }
        #region  BasicMethod
        /// <summary>
        ...
        /// 增加终端用户
        /// </summary>
        public long Add(Model.EndUser model)
        {
        ...
        /// 更新公告
        /// </summary>
        public bool Update(Model.EndUser model)
        {
        ...
        /// 得到公告实体，从缓存中
        /// </summary>
        public Model.EndUser GetModelByCache(long AutoID)
        {
        ...
        /// <returns>数据集</returns>
        public List<Model.EndUser> GetModelList(int key, string value, int Top, int filedOrder, bool desc)
        {
        ...
        /// 将DateTable转成实体类集合
        /// </summary>
        public List<Model.EndUser> DataTableToList(DataTable dt)
        {
            List<Model.EndUser> modelList = new List<Model.EndUser>();
