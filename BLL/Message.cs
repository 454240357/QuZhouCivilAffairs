...
namespace BLL
{
    ...
    {
        private readonly DAL.MySqlMessage dal = new DAL.MySqlMessage();
        public Message()
        { }
        #region  BasicMethod
        /// <summary>
        ...
        /// 增加公告
        /// </summary>
        public long Add(Model.Message model)
        {
        ...
        /// 得到公告实体，从缓存中
        /// </summary>
        public Model.Message GetModelByCache(long AutoID)
        {
        ...
        /// <param name="desc">选用倒序</param>
        /// <returns>数据集</returns>
        public List<Model.Message> GetModelList(int key, string value, int Top, int filedOrder, bool desc)
        {
        ...
        /// <param name="desc">选用倒序</param>
        /// <returns>数据集</returns>
        public List<Model.Message> GetMessageEx(int[] keys, object[] values, int Top, int fieldOrder, bool desc)
        {
