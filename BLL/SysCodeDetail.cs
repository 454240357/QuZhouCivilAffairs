...
namespace BLL
{
	...
	{
        private readonly DAL.MySqlSysCodeDetail dal = new DAL.MySqlSysCodeDetail();
		...
		/// 增加小类
		/// </summary>
		public bool Add(Model.SysCodeDetail model)
		{
		...
		/// 更新小类
		/// </summary>
		public bool Update(Model.SysCodeDetail model)
		{
        ...
        /// 得到小类实体，从缓存中
		/// </summary>
		public Model.SysCodeDetail GetModelByCache(string SYSCodeDetialID)
		{
			...
			return (Model.SysCodeDetail)objModel;
		}
        ...
        /// <param name="desc">选用倒序</param>
        /// <returns>小类集合</returns>
        public List<Model.SysCodeDetail> GetModelList(int key, string value, int Top, int filedOrder, bool desc)
        {
        ...
        /// 将DateTable转成实体类集合
        /// </summary>
        public List<Model.SysCodeDetail> DataTableToList(DataTable dt)
        {
            List<Model.SysCodeDetail> modelList = new List<Model.SysCodeDetail>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Model.SysCodeDetail model;
        ...
        public DataSet GetListBySysCode(string SysCodeDetialID, string SysCodeID)
        {
            ...
            List<Model.SysCodeRelation> syscodeRelationList = scr.GetModelList(1, SysCodeDetialID, -1, -1, false);
            syscodeRelationList.AddRange(scr.GetModelList(2, SysCodeDetialID, -1, -1, false));
            foreach (DataRow dr in ds.Tables[0].Rows)
            {
                Model.SysCodeRelation scrModel = syscodeRelationList.Find(sr => (sr.SysCodeDetialIDEx.Equals(dr[1].ToString()) ||
