...
namespace BLL
{
    ...
    {
        private readonly DAL.MySqlQuestionary qnDal = new DAL.MySqlQuestionary();
        private readonly DAL.MySqlQuestion qsDal = new DAL.MySqlQuestion();
        public Questionary()
        { }
        #region  BasicMethod 
        ...
        /// 新增不带问题的问卷
        /// </summary>
        public long AddEmptyQuestionary(Model.Questionary model)
        {
        ...
        /// 为已存在的问卷新增问题
        /// </summary>
        public long AddQuestion(long _questionaryID,  Model.Question model)
        {
        ...
        /// 新增问卷及其包含的问题
        /// </summary>
        public long AddQuestionary(Model.Questionary _qnModel,Model.Question[] _qsModels )
        {
        ...
        /// 更新问卷标题
        /// </summary>
        public bool UpdateQuestionary(Model.Questionary model)
        {
        ...
        /// 更新某个问题
        /// </summary>
        public bool UpdateQuestion(Model.Question model)
        {
        ...
        /// 得到问卷实体
        /// </summary>
        public Model.Questionary GetQnModel(long _id)
        {
        ...
        /// 得到问题实体
        /// </summary>
        public Model.Question GetQsModel(long _id)
        {
        ...
        /// <param name="value">查询值</param>
        /// <returns>问卷集合</returns>
        public List<Model.Questionary> GetQnModelList(int key, string value)
        {
        ...
        /// <param name="desc">选用倒序</param>
        /// <returns>问卷集合</returns>
        public List<Model.Questionary> GetQnModelList(int key, string value, int Top, int filedOrder, bool desc)
        {
        ...
        /// <param name="desc">选用倒序</param>
        /// <returns>问题集合</returns>
        public List<Model.Question> GetQsModelList(int key, string value, int Top, int filedOrder, bool desc)
        {
        ...
        /// <param name="value">查询值</param>
        /// <returns>数据集</returns>
        public List<Model.Question> GetQsModelList(int key, string value)
        {
        ...
        /// </summary>
        public List<Model.Questionary> DataTableToListForQn(DataTable dt)
        {
            List<Model.Questionary> modelList = new List<Model.Questionary>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Model.Questionary model;
        ...
        /// </summary>
        public List<Model.Question> DataTableToListForQs(DataTable dt)
        {
            List<Model.Question> modelList = new List<Model.Question>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
