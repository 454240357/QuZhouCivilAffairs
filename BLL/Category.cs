...
namespace BLL
{
	...
	{
        private readonly DAL.MySqlCategory dal = new DAL.MySqlCategory();
		public Category()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到分类实体，从缓存中
		/// </summary>
		public Model.Category GetModelByCache(long AutoID)
		{
			
			string CacheKey = "CategoryModel-" + AutoID;
			...
			return (Model.Category)objModel;
		}
        ...
        /// <param name="desc">选用倒序</param>
        /// <returns>分类集合</returns>
        public List<Model.Category> GetModelList(int key, string value, int Top, int filedOrder, bool desc)
        {
        ...
        /// 将DateTable转成实体类集合
        /// </summary>
        public List<Model.Category> DataTableToList(DataTable dt)
        {
            List<Model.Category> modelList = new List<Model.Category>();
