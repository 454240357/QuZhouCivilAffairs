...
namespace BLL
{
    ...
    {
        private readonly DAL.MySqlBusLine dal = new DAL.MySqlBusLine();
        public BusLine()
        { }
        #region  BasicMethod
        /// <summary>
        ...
        /// 增加公交线路
        /// </summary>
        public long AddBusLine(Model.BusLine model,out string msg)
        {
        ...
        public List<Model.BusLine> BusLineFilterByName(DataTable ds,string value)
        {
        ...
        /// </summary>
        public List<Model.BusLine> DataTableToList(DataTable dt)
        {
            List<Model.BusLine> modelList = new List<Model.BusLine>();
