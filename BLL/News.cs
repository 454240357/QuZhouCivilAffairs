...
namespace BLL
{
	...
	{
        private readonly DAL.MySqlNews dal = new DAL.MySqlNews();
		public News()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 增加新闻
		/// </summary>
		public long Add(Model.News model)
		{
        ...
        /// 得到新闻实体，从缓存中
		/// </summary>
		public Model.News GetModelByCache(long AutoID)
		{
        ...
        /// <param name="desc">选用倒序</param>
        /// <returns>新闻集合</returns>
        public List<Model.News> GetModelList(int key, string value, int Top, int filedOrder, bool desc)
        {
        ...
        /// 将DateTable转成实体类集合
        /// </summary>
        public List<Model.News> DataTableToList(DataTable dt)
        {
            List<Model.News> modelList = new List<Model.News>();
