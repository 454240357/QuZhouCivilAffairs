...
namespace BLL
{
    ...
    {
        private readonly DAL.MySqlMessageToObject dal = new DAL.MySqlMessageToObject();
        ...
        /// 得到公告对象关联实体，从缓存中
        /// </summary>
        public Model.MessageToObject GetModelByCache(long AutoID)
        {
            ...
            return (Model.MessageToObject)objModel;
        }
        ...
        /// <param name="desc">选用倒序</param>
        /// <returns>公告对象关联集合</returns>
        public List<Model.MessageToObject> GetModelList(int key, string value, int Top, int filedOrder, bool desc)
        {
        ...
        /// 将DateTable转成实体类集合
        /// </summary>
        public List<Model.MessageToObject> DataTableToList(DataTable dt)
        {
            List<Model.MessageToObject> modelList = new List<Model.MessageToObject>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Model.MessageToObject model;
