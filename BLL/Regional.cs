...
namespace BLL
{
	...
	{
		private readonly DAL.MySqlRegional dal=new DAL.MySqlRegional();
		public Regional()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 更新区域
		/// </summary>
		public bool Update(Model.Regional model)
		{
		...
		/// 得到区域实体
		/// </summary>
        public Model.Regional GetModel(string RegionalID)
		{
		...
		/// 得到区域对象实体，从缓存中
		/// </summary>
        public Model.Regional GetModelByCache(string RegionalID)
		{
			...
			return (Model.Regional)objModel;
		}
        ...
        /// <param name="desc">选用倒序</param>
        /// <returns>区域集合</returns>
        public List<Model.Regional> GetModelList(int key, string value, int Top, int filedOrder, bool desc)
        {
        ...
        /// 将DateTable转成实体类集合
        /// </summary>
        public List<Model.Regional> DataTableToList(DataTable dt)
        {
            List<Model.Regional> modelList = new List<Model.Regional>();
        ...
        /// <param name="desc">选用倒序</param>
        /// <returns>区域集合</returns>
        public List<Model.Regional> GetModelListValid(int key, string value, int Top, int filedOrder, bool desc)
        {
