...
namespace BLL
{
    ...
    {
        private readonly DAL.MySqlUserPrize dal = new DAL.MySqlUserPrize();
        public UserPrize()
        { }
        #region  BasicMethod
        ...
        /// 兑换奖品
        /// </summary>
        public void Add(Model.UserPrize model,out string msg)
        {
        ...
        public void Delete(Model.UserPrize model, out string msg)
        {
        ...
        /// <param name="desc">选用倒序</param>
        /// <returns>UserPrize集合</returns>
        public List<Model.UserPrize> GetModelList(int key, string value, int Top, int filedOrder, bool desc)
        {
        ...
        /// 将DateTable转成实体类集合
        /// </summary>
        public List<Model.UserPrize> DataTableToList(DataTable dt)
        {
            List<Model.UserPrize> modelList = new List<Model.UserPrize>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Model.UserPrize model;
