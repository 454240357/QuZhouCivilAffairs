...
namespace BLL
{
    ...
    {
        private readonly DAL.MysqlIntegral dal=new DAL.MysqlIntegral();
        public Integral()
		{}
        #region  BasicMethod
        /// <summary>
        ...
        /// 增加实体
        /// </summary>
        public bool Add(Model.Integral model)
        {
        ...
        ///// 更新日志
        ///// </summary>
        //public bool Update(Model.Integral model)
        //{
        ...
        /// 得到对象实体，从缓存中
        /// </summary>
        public Model.Integral GetModelByCache(long AutoID)
        {

            string CacheKey = "IntegralModel-" + AutoID;
            ...
            return (Model.Integral)objModel;
        }
        ...
        /// <param name="filedOrder">排序字段 0：AutoID 1：SimCardNo 2：Items 3：IntegralAdded 4：TotalIntegral 其他:不排序</param>
        ...
        /// <param name="desc">选用倒序</param>
        /// <returns>集合</returns>
        public List<Model.Integral> GetModelList(int key, string value, int Top, int filedOrder, bool desc)
        {
        ...
        /// 将DateTable转成实体类集合
        /// </summary>
        public List<Model.Integral> DataTableToList(DataTable dt)
        {
            List<Model.Integral> modelList = new List<Model.Integral>();
        ...
        public List<Model.Integral> GetModelListView()
        {
            string strWhere = " LastModifyTime = (select max(LastModifyTime) from Integral IG where IG.SimCardNo = I.SimCardNo )";
