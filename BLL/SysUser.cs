...
namespace BLL
{
	...
	{
        private readonly DAL.MySqlSysUser dal = new DAL.MySqlSysUser();
		public SysUser()
		{}
		#region  BasicMethod
		/// <summary>
        ...
        /// 增加操作员
		/// </summary>
		public bool Add(Model.SysUser model)
		{
        ...
        /// 更新操作员
		/// </summary>
		public bool Update(Model.SysUser model)
		{
        ...
        /// 得到操作员
		/// </summary>
		public Model.SysUser GetModel(string UserID)
		{
        ...
        /// 得到操作员，从缓存中
		/// </summary>
		public Model.SysUser GetModelByCache(string UserID)
		{
        ...
        /// <param name="desc">选用倒序</param>
        /// <returns>操作员集合</returns>
        public List<Model.SysUser> GetModelList(int key, string value, int Top, int filedOrder, bool desc)
        {
        ...
        /// 将DateTable转成实体类集合
        /// </summary>
        public List<Model.SysUser> DataTableToList(DataTable dt)
        {
            List<Model.SysUser> modelList = new List<Model.SysUser>();
