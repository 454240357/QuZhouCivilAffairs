...
namespace BLL
{
	...
	{
        private readonly DAL.MySqlSysCode dal = new DAL.MySqlSysCode();
		public SysCode()
		{}
		#region  BasicMethod
		/// <summary>
        ...
        /// 增加大类
		/// </summary>
		public bool Add(Model.SysCode model)
		{
        ...
        /// 更新大类
		/// </summary>
		public bool Update(Model.SysCode model)
		{
        ...
        /// 得到大类实体
		/// </summary>
		public Model.SysCode GetModel(string SYSCodeID)
		{
        ...
        /// 得到大类实体，从缓存中
		/// </summary>
		public Model.SysCode GetModelByCache(string SYSCodeID)
		{
        ...
        /// <param name="desc">选用倒序</param>
        /// <returns>大类集合</returns>
        public List<Model.SysCode> GetModelList(int key, string value, int Top, int filedOrder, bool desc)
        {
        ...
        /// 将DateTable转成实体类集合
        /// </summary>
        public List<Model.SysCode> DataTableToList(DataTable dt)
        {
            List<Model.SysCode> modelList = new List<Model.SysCode>();
