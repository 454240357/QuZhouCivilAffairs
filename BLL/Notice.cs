...
namespace BLL
{
    ...
    {
        private readonly DAL.MySqlNotice dal = new DAL.MySqlNotice();
        public Notice()
        { }
        #region  BasicMethod
        /// <summary>
        ...
        /// 增加公告
        /// </summary>
        public long Add(Model.Notice model)
        {
        ...
        /// 得到公告实体
        /// </summary>
        public Model.Notice GetModel(long AutoID)
        {
        ...
        /// 得到公告实体，从缓存中
        /// </summary>
        public Model.Notice GetModelByCache(long AutoID)
        {
        ...
        /// 根据条件获取公告列表(list)
        /// </summary> 
        public List<Model.Notice> GetModelList(int key, string value, int Top, int filedOrder, bool desc)
        {
        ...
        /// 将DateTable转成实体类集合
        /// </summary>
        public List<Model.Notice> DataTableToList(DataTable dt)
        {
            List<Model.Notice> modelList = new List<Model.Notice>();
