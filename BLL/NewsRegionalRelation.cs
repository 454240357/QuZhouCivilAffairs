...
namespace BLL
{
	...
	{
        private readonly DAL.MySqlNewsRegionalRelation dal = new DAL.MySqlNewsRegionalRelation();
        ...
        /// 更新新闻区域关联
		/// </summary>
		public bool Update(Model.NewsRegionalRelation model)
		{
        ...
        /// 得到新闻区域关联实体
		/// </summary>
		public Model.NewsRegionalRelation GetModel(long AutoID)
		{
        ...
        /// 得到新闻区域关联实体，从缓存中
		/// </summary>
		public Model.NewsRegionalRelation GetModelByCache(long AutoID)
		{
			...
			return (Model.NewsRegionalRelation)objModel;
		}
        ...
        /// <param name="desc">选用倒序</param>
        /// <returns>新闻区域关联集合</returns>
        public List<Model.NewsRegionalRelation> GetModelList(int key, string value, int Top, int filedOrder, bool desc)
        {
        ...
        /// 将DateTable转成实体类集合
        /// </summary>
        public List<Model.NewsRegionalRelation> DataTableToList(DataTable dt)
        {
            List<Model.NewsRegionalRelation> modelList = new List<Model.NewsRegionalRelation>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Model.NewsRegionalRelation model;
