...
namespace BLL
{
	...
	{
        private readonly DAL.MySqlSysCodeRelation dal = new DAL.MySqlSysCodeRelation();
        ...
        /// 增加代码关联
		/// </summary>
		public long Add(Model.SysCodeRelation model)
		{
        ...
        /// 更新代码关联
		/// </summary>
		public bool Update(Model.SysCodeRelation model)
		{
        ...
        /// 得到代码关联实体，从缓存中
		/// </summary>
		public Model.SysCodeRelation GetModelByCache(long AutoID)
		{
			...
			return (Model.SysCodeRelation)objModel;
		}
        ...
        /// <param name="desc">选用倒序</param>
        /// <returns>代码关联集合</returns>
        public List<Model.SysCodeRelation> GetModelList(int key, string value, int Top, int filedOrder, bool desc)
        {
        ...
        /// 将DateTable转成实体类集合
        /// </summary>
        public List<Model.SysCodeRelation> DataTableToList(DataTable dt)
        {
            List<Model.SysCodeRelation> modelList = new List<Model.SysCodeRelation>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Model.SysCodeRelation model;
