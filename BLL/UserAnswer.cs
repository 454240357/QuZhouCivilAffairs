...
namespace BLL
{
    ...
    {
        private readonly DAL.MySqlUserAnswer dal = new DAL.MySqlUserAnswer();
        ...
        /// 新增用户对于某问卷下某个问题的答案
        /// </summary>
        public long Add(Model.UserAnswer model)
        {
        ...
        /// 更新某个用户对于某个问题的答案
        /// </summary>
        public bool Update(Model.UserAnswer model)
        {
        ...
        /// 得到答案实体
        /// </summary>
        public Model.UserAnswer GetModel(long _questionID, long _userID)
        {
        ...
        public List<Model.UserAnswer> GetQnModelList(int key, string value, int Top, int filedOrder, bool desc)
        {
        ...
        ///获得所有用户对某个问题的答案
        /// </summary>
        public List<Model.UserAnswer> GetOnModelListForQuestion(long _questionID)
        {
        ...
        /// </summary>
        public List<Model.UserAnswer> DataTableToList(DataTable dt)
        {
            List<Model.UserAnswer> modelList = new List<Model.UserAnswer>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Model.UserAnswer model;
        ...
        public int[] CountAnswers(long _questionID)
        {
            ...
            List<Model.UserAnswer> modelList = GetOnModelListForQuestion(_questionID);
            Model.Question qs = qsDal.GetModel(_questionID);
